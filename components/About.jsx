        ...
        <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
            <div className=" max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                ...
                <div className="col-span-2">
                    ...
                    <p className="py-2 text-gray-600">On my time off, I am either still coding at my local cafe and/or doing archery down at my local range. Scroll down further to know more about me.</p>
                </div>
            </div>
        </div>
    )
